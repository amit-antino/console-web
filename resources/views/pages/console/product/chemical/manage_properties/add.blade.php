        ...
        <div class="modal-dialog modal-dialog-scrollable modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form autocomplete="off" action="{{url('product/chemical/'.___encrypt($property['product_id']).'/addprop')}}" method="POST" enctype="multipart/form-data" role="property_id{{___encrypt($property['property_id'])}}">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <select class="js-example-basic-single prop-id" data-url="{{url('product/chemical/'.___encrypt($property['product_id']).'/property/'.___encrypt($property['property_id']).'/form')}}" data-type="form" data-request="ajax-append-fields" data-target="#add-form-content-{{___encrypt($property['property_id'])}}" alt="{{___encrypt($property['property_id'])}}" name="property_id">
