...
<nav class="page-breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Edit Product System Comparison Report</li>
    </ol>
</nav>
...
<div class="row">
    <div class="col-md-12 stretch-card">
        <div class="card shadow">
            <form action="{{url('/reports/product_system_comparison/store')}}" method="POST">
                <div class="card-header">
                    <h4 class="mb-3 mb-md-0">Edit Product System Comparison Report</h4>
                </div>
                <div class="card-body">
