<ul class="nav nav-tabs nav-tabs-line" id="myTab" role="tablist">
    ...
    @endif
    @if(!empty($data['inputs']['detailed']))
    <li class="nav-item">
        <a class="nav-link font-weight-normal text-uppercase {{!empty($data['inputs']['summary'])?'':'active'}}" id="detailed-tab" data-toggle="tab" href="#detailed" role="tab" aria-controls="detailed" aria-selected="false">Detailed</a>
    </li>
    @endif
</ul>
<div class="tab-content mt-3" id="myTabContent">
    <div class="tab-pane fade {{!empty($data['inputs']['summary'])?'show active':''}}" id="summary" role="tabpanel" aria-labelledby="summary-tab">
        <div class="row">
            <div class="col-md-12 mb-3">
                ...
                <div class="table-responsive">
                    <table id="input_mastercondition" class="table">
                        <thead>
                        ...
                        <tbody class="font-weight-normal">
                            @if(!empty($data['inputs']['summary']))
                            @foreach($data['inputs']['summary'] as $master_condition)
                            <tr>
                                <td>{{$master_condition['condition_name']}}</td>
                                <td>
                                    {{$master_condition['value']}}
                                    @if($master_condition['unit_constant_name'] != "-")
                                    {{$master_condition['unit_constant_name']}}
                                    @endif
                                </td>
                            </tr>
                            @endforeach
