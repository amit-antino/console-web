...
<div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
    ...
    <div class="d-flex align-items-center flex-wrap text-nowrap">
        <a href="{{url('/organization/backup/config')}}" class="btn btn-sm btn-secondary btn-icon-text mb-2 mb-md-0">
                    ...
                    <table id="db_backup_list" class="table table-hover mb-0">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <button type="submit" class="btn btn-sm btn-danger" data-toggle="tooltip" data-placement="bottom" title="Delete Database Backup">
