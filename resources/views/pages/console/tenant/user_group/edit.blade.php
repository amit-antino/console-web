...
<nav class="page-breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{url('organization/'.$tenant_id.'/user_group')}}">User Group</a></li>
...
<div class="row">
    <div class="col-md-12 stretch-card">
        <div class="card shadow">
            <form action="{{url('organization/'.$tenant_id.'/user_group/'.___encrypt($user_group['id']))}}" method="POST" role="dept">
                ...
                <div class="card-footer text-right">
                    ...
                    <a href="{{url('organization/'.$tenant_id.'/user_group')}}" class="btn btn-danger btn-sm">Cancel</a>
                </div>
            </form>
        </div>
    </div>
