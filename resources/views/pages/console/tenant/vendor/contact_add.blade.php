<div class="modal fade" id="vendor_contact_detail{{___encrypt($locations->id)}}" tabindex="-1" role="dialog" aria-labelledby="vendor_contact_detailLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form method="post" role="vendor-contact{{$locations->id}}" action="{{url('organization/vendor/contact')}}" enctype="multipart/form-data">
                <div class="modal-header">
                    <input type="hidden" name="vendor_id" value="{{___encrypt($locations->vendor_id)}}">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select name="location_id" id="location_id" class="form-control">
                                ...
                                <option @if($locations->id==$location->id) selected @endif value="{{___encrypt($location->id)}}">{{$location->location_name}}</option>
                                @endforeach
                                @endif
                            </select>
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="phone_no" id="phone_no" class="form-control" data-inputmask-alias="(+99) 9999-9999" placeholder="Enter Phone Number">
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-sm btn-secondary submit" id="submit_button_id" data-request="ajax-submit" data-target='[role="vendor-contact{{$locations->id}}"]'>Save</button>
                </div>
            </form>
        </div>
    </div>
