...
<div class="form-row">
    ...
    $unit_constant_id = !empty($fields['unit_constant_id'])?$fields['unit_constant_id']:'';
    ...
    <div class="form-group col-md-12">
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <input type="hidden" name="dynamic_prop[{{$count}}][default_constant_id]" value="{{___encrypt($unit_constant_id)}}">
