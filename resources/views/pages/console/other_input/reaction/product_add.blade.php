<div class="modal fade bd-product-modal-md" id="productModal" tabindex="-1" role="dialog" aria-labelledby="modal fade bd-prodcut-modal-md" aria-hidden="true">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-12">
                            <label class="control-label"> STOICHIOMETRIC COEFFICIENT <span class="text-danger">*</span>
                                <span><i class="icon-sm" data-feather="info" data-toggle="tooltip" data-placement="top" title="Enter STOICHIOMETRIC COEFFICIENT"></i></span>
                            </label>
                            <input type="text" class="form-control" name="name" placeholder="Enter Name" required>
                        </div>
                        <div class="form-group col-md-12">
