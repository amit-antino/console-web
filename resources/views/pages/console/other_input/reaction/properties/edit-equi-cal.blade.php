<div class="modal fade" id="equi_calculation_edit{{$property->id}}" tabindex="-1" role="dialog" aria-labelledby="equi_calLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <form method="POST" action="{{url('/other_inputs/reaction/'.$reaction_id.'/addprop/'.___encrypt($property->id))}}" role="equi-cal-edit">
                <div class="modal-header">
                    <h5 class="modal-title" id="equi_calLabel">Edit Calculation</h5>
                ...
                <div class="modal-footer">
                    <button type="button" id="submit_button_id" data-request="ajax-submit" data-target='[role="equi-cal-edit"]' class="btn btn-sm btn-secondary">Save</button>
