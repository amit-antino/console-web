...
<div class="row">
    <div class="col-md-12 stretch-card">
        <div class="card shadow">
            <form method="POST" action="{{url('/models/'.___encrypt($models->id))}}" role="models">
                ...
                <div class="card-body">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input value="{{$models->name}}" type="text" class="form-control" data-request="isalphanumeric" id="name" name="name" placeholder="Enter Name" disabled>
                        </div>
                        <div class="form-group col-md-6">
                        ...
                        <div class="form-group col-md-12">
                            <label for="description">Description
                                <i data-toggle="tooltip" title="Add Description. You can enter maximum 1000 characters. " data-request="isalphanumeric" class="icon-sm" data-feather="info" data-placement="top"></i>
                            </label>
                            <textarea class="form-control" id="description" name="description" data-request="isalphanumeric" placeholder="Enter Description" disabled>{{$models->description}}</textarea>
                        </div>
                        <div class="form-group col-md-12">
                            ...
                            <div id="ace_html">
                                <textarea id="ace_html" name="ace_html" class="ace-editor w-100 ace_editor_val"></textarea>
                            </div>
                        </div>
