  ...
  <table >
    ...
    <tr>
      ...
      <th>{{$master_condition['condition']}} in {{$master_condition['unit_constant']}}<br>
        #{{$master_condition['conditionid']}}#{{$master_condition['unitid']}}#{{$master_condition['unit_constant_id']}}
      </th>
      @endforeach
      @endif
      @if(!empty($data['exp_unit_condition']))
      ...
      <th>{{$condition['condition']}} in {{$condition['unit_constant']}}<br>
        #{{$condition['conditionid']}}#{{$condition['unitid']}}#{{$condition['unit_constant_id']}}
      </th>
      @endforeach
      @endforeach
      @endif
      ...
      <th>{{$master_outcome['outcome']}} in {{$master_outcome['unit_constant']}}<br>
        #{{$master_outcome['outcomeid']}}#{{$master_outcome['unitid']}}#{{$master_outcome['unit_constant_id']}}
      </th>
      @endforeach
      @endif
      @if(!empty($data['exp_unit_outcome']))
      ...
      <th>{{$outcome['outcome']}} in {{$outcome['unit_constant']}}<br>
        #{{$outcome['outcomeid']}}#{{$outcome['unitid']}}#{{$outcome['unit_constant_id']}}
      </th>
      @endforeach
      @endforeach
      @endif
