<div class="modal fade" id="outcome_measured_data_exp_outcome_edit_modal{{$count}}" tabindex="-1" role="dialog" aria-labelledby="outcome_measured_data_exp_outcome_edit_modal" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form method="POST" action="{{url('experiment/experiment/output-measured-data-exp-outcome-addlist?process_experiment_id='.$unit_outcome['experiment_id'])}}" role="edit_output_exp_unit_outcome{{$count}}">
