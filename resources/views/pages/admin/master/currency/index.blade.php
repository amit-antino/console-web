...
<div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
    <div>
        <h4 class="mb-3 mb-md-0">Currency </h4>
    </div>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <div class="btn-group btn-group-sm" role="group">
                                            ...
                                            <a href="javascript:void(0);" data-url="{{url('/admin/master/unit_type/'.___encrypt($unit['id']).'/edit')}}" data-request="ajax-popup" data-target="#edit-div" data-tab="#unitModal{{___encrypt($unit['id'])}}" class="btn btn-icon" data-toggle=" tooltip" data-placement="bottom" title="Edit Currency">
                                                <i class="fas fa-edit text-secondary"></i>
                                            </a>
                                            <a href="javascript:void(0);" data-url="{{url('admin/master/unit_type/'.___encrypt($unit['id']))}}" data-method="DELETE" data-request="ajax-confirm" data-ask_image="warning" data-ask="Are you sure you want to delete?" class="btn btn-icon" data-toggle=" tooltip" data-placement="bottom" title="Delete Currency">
...
@include('pages.admin.master.currency.create')
<div id="edit-div">
</div>
@endsection
