<div class="modal fade bd-product-modal-md" id="editcategoryModal{{___encrypt($cat->id)}}" tabindex="-1" role="dialog" aria-labelledby="modal fade bd-prodcut-modal-md" aria-hidden="true">
    <div class="modal-dialog modal-md" role="document">
        <form method="POST" action="{{url('admin/tenant/'.$tenant_id.'/list/category/'.___encrypt($cat->id))}}" role="category-edit">
                ...
                <div class="modal-body">
                    <div class="form-row">
                        <div class="form-group col-md-12">
                            ...
                            <input type="text" value="{{$cat->category_name}}" class="form-control" name="name" placeholder="Enter Name" required>
                        </div>
                    </div>
                </div>
