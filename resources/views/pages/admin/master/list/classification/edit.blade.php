<div class="modal fade bd-product-modal-md" id="ClassificationModal{{___encrypt($class->id)}}" tabindex="-1" role="dialog" aria-labelledby="modal fade bd-prodcut-modal-md" aria-hidden="true">
    <div class="modal-dialog modal-md" role="document">
        <form method="POST" action="{{url('admin/tenant/'.$tenant_id.'/list/classification/'.___encrypt($class->id))}}" role="classification-edit">
            @CSRF
                ...
                <div class="modal-body">
                    <div class="form-row">
                        <div class="form-group col-md-12">
                            ...
                            <input type="text" value="{{$class->classification_name}}" class="form-control" name="name" placeholder="Enter Name" >
                        </div>
                    </div>
                </div>
