...
<nav class="page-breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{url('/admin/master/chemical/sub_property')}}">Sub Property</a></li>
...
<div class="row">
    <div class="col-md-12 stretch-card">
        <div class="card shadow">
            <form action="{{url('admin/master/chemical/sub_property/'.___encrypt($sub_property->id))}}" role="sub-property" method="POST">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-2">
                                    ...
                                    <button data-types="constant" data-target="#sub-property" data-url="{{url('admin/master/chemical/sub_property/add-more-sub-property-field')}}" data-request="add-another" data-count="{{$total_count}}" type="button" class="btn btn-sm btn-secondary btn-icon" data-toggle="tooltip" data-placement="bottom" title="Add">
