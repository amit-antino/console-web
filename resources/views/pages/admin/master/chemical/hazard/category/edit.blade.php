<div class="modal fade bd-product-modal-md" id="editcategoryModal{{___encrypt($cat->id)}}" tabindex="-1" role="dialog" aria-labelledby="modal fade bd-prodcut-modal-md" aria-hidden="true">
    <div class="modal-dialog modal-md" role="document">
        <form method="POST" action="{{url('admin/master/chemical/hazard/category/'.___encrypt($cat->id))}}" role="category-edit{{___encrypt($cat->id)}}">
            <input type="hidden" name="_method" value="PUT">
            @CSRF
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="productModalLabel">Edit Hazard Category</h5>
                ...
                <div class="modal-footer">
                    <button type="button" id="submit_button_id" data-request="ajax-submit" data-target='[role="category-edit{{___encrypt($cat->id)}}"]' class="btn btn-sm btn-secondary submit">
                        Submit
                    </button>
