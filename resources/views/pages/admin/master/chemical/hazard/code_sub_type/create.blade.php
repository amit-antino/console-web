<div class="modal fade bd-product-modal-md" id="codeSubTypeModal" tabindex="-1" role="dialog" aria-labelledby="modal fade bd-prodcut-modal-md" aria-hidden="true">
    <div class="modal-dialog modal-md" role="document">
        <form method="POST" action="{{url('admin/master/chemical/hazard/code_sub_type')}}" role="sub_code_type">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="productModalLabel">Create code sub type</h5>
                ...
                <div class="modal-body">
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <input type="text" class="form-control" name="name" placeholder="Enter Sub Code Name">
                        </div>
                        <div class="form-group col-md-12">
                ...
                <div class="modal-footer">
                    <button type="button" id="submit_button_id" data-request="ajax-submit" data-target='[role="sub_code_type"]' class="btn btn-sm btn-secondary submit">
                        Submit
                    </button>
