...
<nav class="page-breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{url('/admin/master/energy_utilities/sub_property')}}">Energy Sub Properties</a></li>
        <li class="breadcrumb-item active" aria-current="page">Add Energy Sub Property</li>
    </ol>
</nav>
<div class="row">
    <div class="col-md-12 stretch-card">
        <div class="card shadow">
            <form action="{{url('admin/master/energy_utilities/sub_property/')}}" role="roles" method="POST">
                <div class="card-header">
                    <h4 class="mb-3 mb-md-0">Add Energy Sub Property</h4>
                </div>
                <div class="card-body">
                    @csrf
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-2">
                                    ...
                                    <button data-types="constant" data-target="#sub-property" data-url="{{url('/admin/master/energy_utilities/sub_property/add-more-sub-property-field')}}" data-request="add-another" data-count="0" type="button" class="btn btn-secondary btn-sm btn-icon" data-toggle="tooltip" data-placement="bottom" title="Add">
