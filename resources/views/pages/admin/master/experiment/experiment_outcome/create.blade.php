<div class="modal fade bd-product-modal-md" id="outcomeModal" tabindex="-1" role="dialog" aria-labelledby="modal fade bd-prodcut-modal-md" aria-hidden="true">
    <div class="modal-dialog modal-md" role="document">
        <form method="POST" action="{{url('admin/tenant/'.$tenant_id.'/experiment/outcome')}}" role="outcome">
            @CSRF
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="productModalLabel">Create Experiment Outcome</h5>
                ...
                <div class="modal-body">
                    <div class="form-row">
                        <div class="form-group col-md-12">
                            ...
                            <input type="text" class="form-control" name="name" placeholder="Enter Experiment Outcome Name" required>
                        </div>
                        <div class="form-group col-md-12">
                ...
                <div class="modal-footer">
                    <button type="button" id="submit_button_id" data-request="ajax-submit" data-target='[role="outcome"]' class="btn btn-sm btn-secondary submit">
                        Submit
                    </button>
