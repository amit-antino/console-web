...
<nav class="page-breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ url('admin/tenant/'.$tenant_id.'/experiment/equipment_unit') }}">Experiment Equipment Units</a></li>
        <li class="breadcrumb-item active" aria-current="page">View Experiment Equipment Unit - {{$response_data['name']}}</li>
    </ol>
</nav>
<div class="row">
    <div class="col-md-12 stretch-card">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center flex-wrap grid-margin">
                <div>
                    <h4 class="mb-3 mb-md-0">View Equipment Unit : {{$response_data['name']}}</h4>
                </div>
                <div class="d-flex align-items-center flex-wrap text-nowrap">
                    ...
                    <a href="{{ url('admin/tenant/'.$tenant_id.'/experiment/equipment_unit/'.___encrypt($response_data['id']).'/edit') }}" class="btn btn-sm btn-secondary btn-icon-text mr-2 d-none d-md-block" data-toggle="tooltip" data-placement="bottom" title="Edit Experiment">
            ...
            <div class="card-body">
                ...
                <div class="form-row">
                    <div class="form-group col-md-3">
                        <label for="color_code">Selected Equipmemt Unit Image
                        ...
                        <img src="{{$response_data['exp_equip_unit']['equip_unit_img_url']}}" alt="" class="img-fluid">
                        @else
                    ...
                    <div class="form-group col-md-9">
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label for="exp_unit_name">Equipment Unit Name
