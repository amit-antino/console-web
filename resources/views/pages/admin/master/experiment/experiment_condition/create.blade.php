<div class="modal fade bd-product-modal-md" id="ConditionModal" tabindex="-1" role="dialog" aria-labelledby="modal fade bd-prodcut-modal-md" aria-hidden="true">
    <div class="modal-dialog modal-md" role="document">
        <form method="POST" action="{{url('admin/tenant/'.$tenant_id.'/experiment/condition')}}" role="condition">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="productModalLabel">Create Experiment Condition</h5>
                ...
                <div class="modal-body">
                    <div class="form-row">
                        <div class="form-group col-md-12">
                            ...
                            <input type="text" class="form-control" name="name" placeholder="Enter Experiment Condition Name" required>
                        </div>
                        <div class="form-group col-md-12">
                            ...
                            <select class="form-control" name="unit_type">
                                ...
                                <option value="{{___encrypt($v['id'])}}">{{$v['unit_name']}}</option>
                                @endforeach
                                @endif
                            </select>
                        </div>
                ...
                <div class="modal-footer">
                    <button type="button" id="submit_button_id" data-request="ajax-submit" data-target='[role="condition"]' class="btn btn-sm btn-secondary submit">
                        Submit
                    </button>
