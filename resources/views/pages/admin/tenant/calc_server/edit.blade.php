...
<nav class="page-breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Edit Calculation Services</li>
    </ol>
</nav>
<div class="row">
    <div class="col-md-12 stretch-card">
        <div class="card shadow">
            <form action="{{url('/admin/tenant/'.$tenant_id.'/calc_url/'.___encrypt($calc['id']))}}" method="POST" role="designation">
                <div class="card-header">
                    <h4 class="mb-3 mb-md-0">Edit Calculation Services</h4>
                </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <select class="form-control" name="server_type">
                                ...
                                <option @if($calc['server_type']=='local' ) selected @endif value="local">Local</option>
                                <option @if($calc['server_type']=='stag' ) selected @endif value="stag">Staging</option>
                                <option @if($calc['server_type']=='dev' ) selected @endif value="dev">Development</option>
                                <option @if($calc['server_type']=='prod' ) selected @endif value="prod">Production</option>
                            </select>
                        </div>
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="name" value="{{$calc['name']}}" class="form-control" placeholder="Calculation Services Name" required>
                        </div>
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="version" value="{{$calc['version']}}" class="form-control" placeholder="Calculation Services Version" required>
                        </div>
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="calc_url" value="{{$calc['calc_url']}}" class="form-control" placeholder="Calculation Server Url" required>
                        </div>
                        <div class="form-group col-md-6">
                            <label for="description">Description
                                <span><i class="icon-sm" data-feather="info" data-toggle="tooltip" data-placement="top" title="Add Description"></i></span>
                            </label>
                            <textarea id="description" name="description" class="form-control" maxlength="10000" rows="5" placeholder="Description">{{$calc['description']}}</textarea>
                        </div>
