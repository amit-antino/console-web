...
<div class="row">
    <div class="col-md-12 stretch-card">
        <div class="card shadow">
            <form action="{{url('/admin/tenant/'.___encrypt($tenant->id).'/user/'.___encrypt($user->id))}}" method="POST" role="user">
                ...
                <div class="card-body">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" maxlength="10" value="{{$user->mobile_number}}" name="mobile_number" class="form-control" placeholder="Mobile Number" onkeypress="return isNumber(event)">
                        </div>
                        <div class="form-group col-md-6">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select data-width="100%" class="form-control" name="designation" id="designation">
                                ...
                                <option @if($desig['id']==$tenant_user['designation_id']) selected @endif value="{{___encrypt($desig['id'])}}">{{$desig['name']}} </option>
                                @endforeach
                                @endif
                            </select>
                        </div>
                        <div class="form-group col-md-6">
                            ...
                            <select data-width="100%" class="form-control js-example-basic-single" name="users_type" id="users_type" required>
                                <option @if($user->role=='console_admin') selected  @endif value="console_admin">Console Admin</option>
                                <option @if($user->role=='console') selected @endif value="console">Console User</option>
                            </select>
                        </div>
                    </div>
                    <div class="card-footer text-right">
                        ...
                        <a href="{{url('/admin/tenant/'.___encrypt($tenant->id).'/user')}}" class="btn btn-sm btn-danger">Cancel</a>
                    </div>
                </div>
            </form>
        </div>
