...
<div class="row">
    <div class="col-md-12 stretch-card">
        <div class="card shadow">
            <form action="{{url('/admin/tenant/'.___encrypt($tenant->id).'/user')}}" method="POST" role="user">
                ...
                <div class="card-body">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" maxlength="10" data-request="isalphanumeric" name="mobile_number" class="form-control" placeholder="Mobile Number" onkeypress="return isNumber(event)">
                        </div>
                        <div class="form-group col-md-6">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select data-width="100%" class="form-control js-example-basic-single" name="users_type" id="users_type"  required>
                                <option value="console_admin">Console Admin</option>
