...
@php
$tenant_id= ___encrypt($data_request['tenant_id'])
@endphp
@push('plugin-styles')
...
<nav class="page-breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="{{ url('/admin/dashboard') }}">Dashboard</a></li>
        ...
        <li class="breadcrumb-item active" aria-current="page">Edit Data Request</li>       
    </ol>
</nav>
<div class="row">
    <div class="col-md-12 stretch-card">
        <div class="card shadow">
            <form action="{{url('/admin/tenant/'.$tenant_id.'/data_request/'.___encrypt($data_request['id']))}}" method="POST" role="tenant">
            <input type="hidden" name="_method" value="PUT">
                <div class="card-header">
                    <h4 class="mb-3 mb-md-0">Edit Data Request</h4>
                </div>
                <div class="card-body">
                    <div class="form-row">
                                ...
                                <div class="card-body">
                                    <div class="form-row">
                                        <div class="form-group col-md-6 col-sm-6 col-lg-6">
                                            ...
                                            <input type="text" name="name" class="form-control" value="{{$data_request['name']}}" placeholder="Enter Data Request Name" required>
                                        </div>
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <textarea name="description" id="description" rows="5" class="form-control">{{$data_request['description']}}</textarea>
                                        </div>
