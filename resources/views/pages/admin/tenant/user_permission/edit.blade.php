...
<nav class="page-breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{url('/admin/tenant/'.$tenant_id.'/user_permission')}}">User Pernission</a></li>
...
<div class="row">
    <div class="col-md-12 stretch-card">
        <div class="card shadow">
            <form action="{{url('/admin/tenant/'.$tenant_id.'/user_permission/'.___encrypt($permissions->id))}}" method="POST" role="employee">
