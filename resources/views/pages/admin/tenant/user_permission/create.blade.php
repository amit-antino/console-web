...
<nav class="page-breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{url('/admin/tenant/'.$tenant_id.'/user_permission')}}">User Permission</a></li>
...
<div class="row">
    <div class="col-md-12 stretch-card">
        <div class="card shadow">
            <form action="{{url('/admin/tenant/'.$tenant_id.'/user_permission')}}" method="POST" role="employee">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <select class="form-control" name="permission_type" id="permission_type">
                                <option value="users">Simreka Users</option>
                                <option value="group">User Group</option>
                            </select>
                        </div>
                        <div class="form-group col-md-6 group_section" style="display: none;">
                            <label for="department_id">Select User Group
                                <span class="text-danger">*</span>
                                <span><i class="icon-sm" data-feather="info" data-toggle="tooltip" data-placement="top" title="Select User Group"></i></span>
                            </label>
                            <select class="form-control" data-request="ajax-append-fields" data-url="{{url('admin/tenant/'.$tenant_id.'/user_permission/group_user_list')}}" data-target="#user_id" name="user_group_id" id="user_group_id">
                                            ...
                                            <div class="card border-left-secondary shadow h-100 py-2">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        @else
                                                        @include('pages.admin.tenant.user_permission.sub_menu')
                                                        @endif
                                                    </div>
                                                    @endif
                                                    @endforeach
                ...
                <div class="card-footer text-right">
                    ...
                    <a href="{{url('/admin/tenant/'.$tenant_id.'/user_permission')}}" class="btn btn-danger btn-sm">Cancel</a>
                </div>
            </form>
        </div>
    </div>
...
<script>
    ...
    $('#permission_type').change(function() {
        ...
        if ($val == 'group') {
            ...
            $.ajax({
                type: 'GET',
                url: "{{url('admin/tenant/'.$tenant_id.'/user_permission/group_user_list?parameters='.___encrypt(0))}}",
            ...
            $.ajax({
                type: 'GET',
                url: "{{url('admin/tenant/'.$tenant_id.'/user_permission/group_user_list')}}",
                data: '_token = <?php echo csrf_token() ?>',
                success: function(data) {
                    $('#user_id').html(data.html);
                }
