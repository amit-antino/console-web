...
<nav class="page-breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Data/Models Update</li>
    </ol>
</nav>
<div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
    <div>
        <h4 class="mb-3 mb-md-0">Data/Models Update</h4>
    </div>
                    ...
                    <table id="tenant_list" class="table table-hover mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select data-request="ajax-confirm-onchange" data-ask_image="warning" data-ask="Are you sure? You want to change status." data-method="DELETE" data-url="{{ url('admin/tenant/' . ___encrypt($tenant_id) . '/experiment/dataset_request/' . ___encrypt($val['id'])) }}" class="form-control" id="status" name="status">
                                ...
                                <td class="text-center">
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" class="custom-control-input" data-url="{{ url('/admin/tenant/' . ___encrypt($tenant_id) . '/experiment/dataset_request/' . ___encrypt($val['id']) . '?operation_status=' . $val['operation_status']) }}" data-method="DELETE" data-request="ajax-confirm" data-ask_image="warning" data-ask="Are you sure? You want to change status." id="customSwitch{{ ___encrypt($val['id']) }}" @if ($val['operation_status']=='active' ) checked @endif>
                                ...
                                <td class="text-center">
                                    ...
                                    <a href="javascript:void(0);" class="btn btn-icon" data-toggle="tooltip" data-placement="bottom" title="Delete Model" data-url="{{ url('/admin/tenant/' . ___encrypt($tenant_id) . '/experiment/dataset_request/' . ___encrypt($val['id'])) }}" data-method="DELETE" data-request="ajax-confirm" data-ask_image="warning" data-ask="Are you sure? You want to Delete.">
